...
if ( ! function_exists( 'palm_beach_setup' ) ) :
	...
	function palm_beach_setup() {
		 ...
		 * If you're building a theme based on Palm Beach, use a find and replace
		 * to change 'palm-beach' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'palm-beach' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'palm_beach_custom_background_args', array(
...
function palm_beach_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'palm_beach_content_width', 640 );
}
...
function palm_beach_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'palm-beach' ),
